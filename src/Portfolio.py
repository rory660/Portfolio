...
LIST_SYMBOLS = [SYMBOL_REPO_OWNER, SYMBOL_REPO_OWNER_URL, SYMBOL_REPO_OWNER_AVATAR_URL, SYMBOL_REPO_NAME, SYMBOL_REPO_URL, SYMBOL_COMMITS, SYMBOL_ADDITIONS, SYMBOL_DELETIONS, SYMBOL_TOTAL_COMMITS, SYMBOL_TOTAL_ADDITIONS, SYMBOL_TOTAL_DELETIONS, SYMBOL_LANGUAGES]
